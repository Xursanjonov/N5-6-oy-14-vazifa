...
const AdminHeader = () => {
    return (
        <div className="admin__header w-[100%] sticky top-0 px-9 py-2 flex items-center justify-between shadow-md shadow-gray-400 bg-white">
            <button
            ...
            <div className="px-3 py-1 flex items-center justify-center gap-5 bg-transparent font-semibold text-black">
                <p className="text-lg">Sanjarchik</p>
